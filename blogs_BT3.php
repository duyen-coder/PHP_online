...
// Câu lệnh truy vấn
$query_recent_posts = "SELECT * FROM posts ORDER BY created_at limit 6";
...
// Câu lệnh truy vấn
$query_posts = "SELECT * FROM posts ORDER BY created_at limit 6,2";
...
// Câu lệnh truy vấn
$query_posts2 = "SELECT * FROM posts ORDER BY created_at limit 8,2";

// Thực thi câu lệnh
$result_posts2 = $conn->query($query_posts2);

// Tạo 1 mảng để chứa dữ liệu
$posts2 = array();

while($row = $result_posts2->fetch_assoc()){
	$posts2[] = $row;
}

// Câu lệnh truy vấn
$query_posts3 = "SELECT * FROM posts ORDER BY created_at limit 10,2";

// Thực thi câu lệnh
$result_posts3 = $conn->query($query_posts3);

// Tạo 1 mảng để chứa dữ liệu
$posts3 = array();

while($row = $result_posts3->fetch_assoc()){
	$posts3[] = $row;
}
?>
							...
							<div class="col-md-12">
								<div class="post post-thumb">
									...
									<div class="post-body">
										...
										<h3 class="post-title"><?php echo $post['title']; ?></a></h3>
									</div>
								</div>
							</div>
							<!-- /post -->
